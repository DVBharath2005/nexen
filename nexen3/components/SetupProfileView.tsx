...
import { ArrowRight, User as UserIcon, Sparkles, Upload } from 'lucide-react';
...
const SetupProfileView: React.FC<SetupProfileViewProps> = ({ user, onComplete }) => {
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900/80 backdrop-blur-md rounded-[32px] shadow-2xl shadow-blue-200 dark:shadow-blue-900/20 border border-slate-200 dark:border-white/10 p-6 relative animate-in zoom-in-95 duration-500">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-black text-slate-900 dark:text-white leading-tight">Welcome to the Club!</h1>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium">Let's build your professional identity on Nexen.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col items-center justify-center mb-4">
            ...
            >
              {formData.avatar ? (
                ...
                <div className="w-full h-full bg-slate-100 dark:bg-white/5 flex items-center justify-center overflow-hidden">
                  <svg className="w-full h-full text-slate-300 dark:text-white/20" viewBox="0 0 24 24" fill="currentColor">
            ...
            />
            <p className="mt-2 text-[10px] font-bold text-blue-600 dark:text-blue-400 cursor-pointer hover:underline" onClick={() => fileInputRef.current?.click()}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <label className="text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest ml-1">Username</label>
              <div className="relative">
          ...
          <div className="space-y-1.5">
            <label className="text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest ml-1">Short Bio</label>
            <textarea 
